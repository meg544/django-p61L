...
urlpatterns = [path('admin/', admin.site.urls),
    ...
    path("listar-gastos-proveedor/<int:proveedor_id>/", listar_gastos_proveedor, name="listar_gastos_proveedor"),
